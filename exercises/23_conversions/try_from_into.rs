...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        Color::try_from([tuple.0, tuple.1, tuple.2].as_slice())
    }
}
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        Color::try_from([arr[0], arr[1], arr[2]].as_slice())
        // for color in arr {
        //     if color > u8::MAX.into() || color < u8::MIN.into() {
        //         return Err(IntoColorError::IntConversion);
        //     }
        // }
        // let arr = arr.map(|n| n as u8);
        // Ok(Self {
        //     red: arr[0],
        //     green: arr[1],
        //     blue: arr[2],
